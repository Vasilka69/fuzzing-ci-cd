...
## 5. Дипломно-достаточные задачи

- [ ] `DIP-001 [DIPLOMA]` Поддержать все шаблоны из `V0002__data.sql` хотя бы через validation + documented unsupported mode.
- [ ] `DIP-004` — зафиксировать contract tests на result payloads, чтобы дальнейшие изменения не ломали события.
- [ ] Service DIP-задачи по сервисам:
- [ ] `STORAGE-DIP-*` Выполнить DIPLOMA задачи из `docs/tasks/TASKS-storage-service.md`.
- [ ] `VCS-DIP-*` Выполнить DIPLOMA задачи из `docs/tasks/TASKS-vcs-service.md`.
- [ ] `BUILD-DIP-*` Выполнить DIPLOMA задачи из `docs/tasks/TASKS-build-service.md`.
- [ ] `SCRIPT-DIP-*` Выполнить DIPLOMA задачи из `docs/tasks/TASKS-script-service.md`.
- [ ] `FUZZING-DIP-*` Выполнить DIPLOMA задачи из `docs/tasks/TASKS-fuzzing-service.md`.
- [ ] `DEPLOY-DIP-*` Выполнить DIPLOMA задачи из `docs/tasks/TASKS-deploy-service.md`.
